...
class ModalBoxplus extends React.Component {
  constructor(props) {
    super(props);
    // onBackdropPress
  }
...
const mapDispatchToProps = (dispatch) => {
    return {
      hideModal: () => dispatch({ type: ActionTypes.SHOWMODALPLUS, showModal: false })
    };
};

// Exports
export default connect(mapStateToProps, mapDispatchToProps)(ModalBoxplus);